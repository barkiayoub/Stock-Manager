        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="row g-3" method="POST" action="modifierCat.php">
                        <div class="col-12"> <label for="inputNanme4" class="form-label">Category Name</label>
                            <input value="<?= $cati->nomcat ?>" type="text" class="form-control" name="nomcat" id="inputNanme4">
                        </div>
                        <div class="col-12"> <label for="inputNanme4" class="form-label"> </label>
                            <input value="<?= $cati->id ?>" type="hidden" class="form-control" name="id" id="inputNanme4">
                        </div>
