...
<body>
    ...
    <aside id="sidebar" class="sidebar">
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" data-bs-target="#components-nav" href="categories.html"> <i class="bi bi-menu-button-wide"></i><span>Categories</span>
                </a>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <a href="addcatform.html"> <button class="btn btn-primary">New Category</button></a>
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            <?php
                            $lst = Category::listeDesCat();
                            foreach ($lst as $cati) {
                            ?>
                                <tr>
                                    <td><?= $cati->id ?></td>
                                    <td><?= $cati->nomcat ?></td>
                                    <td><a href="modcatform.php?id=<?= $cati->id ?>">Modify</a></td>
                                    <td>Delete</td>
